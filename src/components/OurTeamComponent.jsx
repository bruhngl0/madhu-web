    ...
    return (
        ...
        <img src = "cona.png" className='team-one' />
            ...
            <div className="team-member">
                <img src="reeakhil.png" alt="Team Member 1" className="team-photo" />
            ...
            {/* Team Member 2 */}
            <div className="team-member">
                <img src="reemadhu.png" alt="Team Member 2" className="team-photo" />
                <div className="team-description">
                    <h3>MADHU MJ</h3>
                    <p>Co-Founder</p>
            ...
            {/* Team Member 3 */}
            <div className="team-member">
                <img src="reerahul.png" alt="Team Member 3" className="team-photo" />
                <div className="team-description">
